...
public class FragmentCatalogListBindingImpl extends FragmentCatalogListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.showLoading == variableId) {
            ...
            setViewModel((usa.overplay.task.features.catalog.CatalogListViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable usa.overplay.task.features.catalog.CatalogListViewModel ViewModel) {
