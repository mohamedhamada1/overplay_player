package usa.overplay.task.features.catalog.databinding;
import usa.overplay.task.features.catalog.R;
import usa.overplay.task.features.catalog.BR;
...
public class RowProductItemBindingImpl extends RowProductItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((usa.overplay.task.core.remote.ui.Product) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable usa.overplay.task.core.remote.ui.Product Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        usa.overplay.task.core.remote.ui.Product item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            usa.overplay.task.commons.ui.bindings.ImageViewBindingsKt.imageUrl(this.IVImg, itemProductImg, (android.graphics.drawable.Drawable)null, (android.graphics.drawable.Drawable)null, (boolean)false);
